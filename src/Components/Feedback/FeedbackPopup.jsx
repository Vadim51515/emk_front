            ...
            <div className={styles.feedbackPopupFon}>
                <div className={styles.popup}>
                    ...
                    <div className={styles.body}>
                        <p style={{ marginBottom: 10 }}>Введите свой номер телефона</p>
                        {
                            numberError &&
                        ...
                        >Введите свою электронную почту</p>
                        {emailError &&
                            <p className={styles.error}> Это поле обязательно</p>
                        }
                        <input
                        ...
                        <textarea
                            ...
                            placeholder='Здесь вы можете оставить свой комментарий'
                        />
                        <button
                            onClick={(e) => {
                                addMessage()
                            ...
                            className={styles.button}>Отправить</button>
                    </div>
                </div>
            </div>
