...
const Sport = () =>{
    return(
        <div className={styles.sport}>
            ...
            <img className={styles.cupsImg} alt='Кубки'src='./img/cups.png'/>
            </div>
            <hr style={{marginBottom:30, marginTop:30}}/>
            ...
            <hr style={{marginBottom:30, marginTop:30}}/>
            <div className={styles.cupsBox}>
                <img className={styles.cupsImg} alt='Расписание занятий'src='./img/timetable.png '/>
            </div>
            <hr style={{marginBottom:30, marginTop:30}}/>
            <h1>Результаты выступлений  2019/2020 учебного года</h1>
            <hr style={{marginBottom:30, marginTop:30}}/>
            <div className={styles.cupsBox}>
                <img className={styles.cupsImg} alt='Результаты выступлений'src='./img/rezult.png '/>
            </div>
