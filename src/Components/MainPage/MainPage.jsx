...
const MainPage = () => {
    ...
    <div data-src="./img/slide_1.png" />
            ...
            <div className={styles.imgHistoryBox}>
                <img alt="Фото здание ЕМК в начале 20 века" src='./img/buildingEmk.png' className={styles.imgHistory} />
            </div>
            ...
            <div className={styles.imgHistoryBox}>
                <img alt="Фото мемориальной доски" src='./img/memorial.png' className={styles.imgHistory} />
            </div>
            ...
            <div className={styles.imgHistoryBox}>
                <img alt="Фото здания по электротехнике" src='./img/building.png' className={styles.imgHistory} />
            </div>
            ...
            <div className={styles.imgHistoryBox}>
                <img alt="Здание Екатеринбургского монтажного колледжа сегодня" src='./img/newCollege.png' className={styles.imgHistory} />
            </div>
            ...
            <div className={styles.imgHistoryBox}>
                <img alt="Действующий директор ЕМК" src='./img/Director.png' className={styles.imgHistory} />
            </div>
            ...
            молодые профессионалы», являясь соорганизатором регионального этапа чемпионата рабочих профессий.
             ...
             За этот период выпущено свыше 28 тысяч специалистов строительной сферы, из них около 1700
              ...
              свою судьбу.</p>
            <div className={styles.imgHistoryBox}>
                <img alt=">Студенты монтажного колледжа – победители регионального 
            этапа WorldSkills Russia - 2018" src='./img/worldskills.png' className={styles.imgHistory} />
            </div>
